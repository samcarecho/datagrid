...
export const CombinedMixin = superClass => class CombinedMixin extends superClass {
  ...
  static get observers() {
    return ['_a11yUpdateGridSize(size, _columnTree, _columnTree.*)', '_detailsOpenedItemsChanged(detailsOpenedItems.*, dataProvider, _rowDetailsTemplate, _physicalCountVal)', '_itemsChanged(items, items.*, isAttached)', '_rowDetailsTemplateChanged(_rowDetailsTemplate)', '_selectedItemsChanged(selectedItems.*)'];
  }
  ...
  ready() {
    ...
    this.addEventListener('cell-activate', this._activateItem.bind(this)); // With Polymer 2 & shady the 'sorter-changed' listener isn't guaranteed to be registered
