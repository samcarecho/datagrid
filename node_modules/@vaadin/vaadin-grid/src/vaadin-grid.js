...
import { CombinedMixin } from './vaadin-grid-combined-mixin.js';
...
class GridElement extends ElementMixin(ThemableMixin(DataProviderMixin(ScrollMixin(KeyboardNavigationMixin(CombinedMixin(ColumnReorderingMixin(ScrollerElement))))))) {
  static get template() {
    return html`
